...
export default function PageSine({ onNavigate }: Props) {
  return (
    <div className="page active" id="page-sine">

      <section className="section">
        <div className="container">
          <div className="section-eyebrow">SINE · Benjamin Constant</div>
          <h2>Oportunidades de emprego perto de você.</h2>
          <p className="sub">O posto municipal do SINE — Sistema Nacional de Emprego — é operado pela SEMEE e conecta trabalhadores e empregadores de Benjamin Constant: cadastro de currículo, divulgação de vagas, encaminhamento para entrevistas e orientação sobre direitos do trabalhador.</p>

          <div className="comp-grid">
            <div className="comp-card reveal"><div className="comp-num">§ 01</div><h4>Cadastro de currículo</h4><p>Cadastre seu perfil profissional no posto do SINE para concorrer às vagas divulgadas no município.</p></div>
            ...
            <div className="comp-card reveal reveal-delay-1"><div className="comp-num">§ 05</div><h4>Para empregadores</h4><p>Anuncie vagas e receba candidatos pré-selecionados pelo posto do SINE, sem custo.</p></div>
          ...
          <div className="lei-box reveal" style={{ marginTop: '2.5rem' }}>
            <div>
              ...
              <p>As vagas abertas passarão a ser publicadas nesta página. Enquanto isso, consulte o posto do SINE presencialmente ou fale com a SEMEE.</p>
            </div>
